    ...
    <div class="container" id="login" style="padding-top: 3%;text-align: center;text-transform: uppercase; 	width: 100%;height: 500px;padding: 15px;padding-top: 30px;">
        ...
        <div class="col-lg-8">
          <div class="login">
            ...
            <h1 style="	margin-top: 2px;font-weight: bold;font-size: 60px;letter-spacing: 3px;">Login</h1>
            
                  <form action="validate.jsp" method="post" style="max-width: 420px;margin: 30px auto;">
                    <div class="form-group">
                      <input type="text" name="n" class="form-control" id="exampleInputEmail1"  placeholder="Enter UserName">
                      
                    </div>
                    <div class="form-group">
                      <input type="password" name="p" class="form-control" id="exampleInputPassword1" placeholder="Password" >
                    </div>
                      ...
                      <label><a href="signin.jsp" style="color:black; font-size:19px;">Create New Account</a></label> 

                    </div>
                  
                    <br>
                    <button type="submit" name="submit" class="btn btn-lg btn-block btn-success" style="	border-radius: 50px;text-transform: uppercase;font-weight: bold;letter-spacing: 2px;font-size: 20px;padding: 14px;background-color:#3b3734;">Log in</button>
                  </form>
