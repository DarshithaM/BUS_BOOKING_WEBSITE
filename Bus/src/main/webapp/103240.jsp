...
<center><h1 style="text-align:center; font-size:40px; font-family:Times New Roman">Trichy To Chennai Bus</h1></center>
<center><h3 style="text-align:center; font-size:28px; font-family:Times New Roman">Book Your Seats</h3></center>
<center>
<form action="t2.jsp" method="post"  style="font-size:25px;">
...
try{
	...
	String q="SELECT alloted,seatno FROM bus2";
