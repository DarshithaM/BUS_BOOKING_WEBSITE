...
<center><h1 style="text-align:center; font-size:40px; font-family:Times New Roman">Madurai To Chennai Bus</h1></center>
<center><h3 style="text-align:center; font-size:28px; font-family:Times New Roman">Book Your Seats</h3></center>
<center>
<form action="t1.jsp" method="post"  style="font-size:25px;">
<input type="checkbox" name="c" value=1 style="transform : scale(3);"></input>&nbsp;&nbsp;&nbsp;
<input type="checkbox" name="c" value=2 style="transform : scale(3);"></input></br></br>
...
<input type="checkbox" name="c" value=6 style="transform : scale(3);"></input></br></br>
...
<input type="checkbox" name="c" value=10 style="transform : scale(3);"></input></br></br>
